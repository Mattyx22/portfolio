...
const Work = () => {
    ...
    const scaleImage1 = useTransform(scrollYProgress, [0.2, 0.3, 0.36, 0.4, 0.41], [0, 0.8, 0.4, 0.4, 0]);
    ...
    const scaleImage2 = useTransform(scrollYProgress, [0.50, 0.60, 0.66, 0.70, 0.75], [0, 0.8, 0.4, 0.4, 0]);

    const opacityDesc2 = useTransform(scrollYProgress, [0.57, 0.61, 0.66, 0.71], [0, 1, 1, 0]);
    ...
    return (
        <div className={styles.height} ref={targetRef}>
            ...
            <motion.div style={{ position, top: "20vh", opacity: opacityDesc2 }}>
                <span className={styles.projectTitle2}>Loca</span>
            </motion.div>
